...
//         <span className="text-xl bg-orange-400 px-4 py-1 rounded-full text-white">{blog.category}</span>

//         <div className="flex items-center gap-4 my-2 ml-14">
//           <div className="flex items-center justify-center font-semibold w-[50px] h-[50px] bg-orange-300
//           text-center text-white rounded-full text-3xl">
//             {blog?.author?.name?.substring(0, 1)}</div>
